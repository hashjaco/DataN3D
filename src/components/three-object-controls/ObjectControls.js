...
const ObjectControls = (camera, domElement, objectToMove) => {
   ...
   *     rotation)
   * @return boolean if the rotation with the new delta is included into the
  ...
  function onTouchEnd(e) {
     ...
     * fingers, currentTouches.length is 0, this means the zooming phase is
     * ended.
     */
